...
class NotificheLavoratore extends StatelessWidget {
          ...
          builder: (context, snapshot) {
            ...
            return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  return NotificaLavoratore(notifica: snapshot.data[index]);
                });
          },
        ),
      ),
...
class NotificaLavoratore extends StatelessWidget {

  var notifica;

  NotificaLavoratore({this.notifica});
